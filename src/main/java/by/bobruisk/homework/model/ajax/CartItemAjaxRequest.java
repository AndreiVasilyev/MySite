...
public class CartItemAjaxRequest {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CartItemAjaxRequest other = (CartItemAjaxRequest) obj;
	...
	public String toString() {
		return "CartItemAjaxRequest [printerId=" + printerId + ", itemsQuantity=" + itemsQuantity + ", currentPrice="
				+ currentPrice + ", isChips=" + isChips + ", isFlash=" + isFlash + ", flashQuantity=" + flashQuantity
				+ "]";
	}
